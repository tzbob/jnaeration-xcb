...
/**
 * <i>native declaration : xcb/xproto.h:257</i><br>
...
public class xcb_screen_iterator_t extends Structure {
	 ...
	 * C type : xcb_screen_t*
	 */
	public xcb.xcb_screen_t.ByReference data;
	/** < */
	public int rem;
	/** < */
	public int index;
	...
	/**
	 * @param data <<br>
	 * C type : xcb_screen_t*<br>
	 * @param rem <<br>
	 * @param index <
	 */
	public xcb_screen_iterator_t(xcb.xcb_screen_t.ByReference data, int rem, int index) {
		super();
		this.data = data;
		this.rem = rem;
		this.index = index;
