...
/**
 * <i>native declaration : xcb/xproto.h:148</i><br>
...
public class xcb_arc_iterator_t extends Structure {
	 ...
	 * C type : xcb_arc_t*
	 */
	public xcb.xcb_arc_t.ByReference data;
	/** < */
	public int rem;
	/** < */
	public int index;
	 ...
	 * @param index <
	 */
	public xcb_arc_iterator_t(xcb.xcb_arc_t.ByReference data, int rem, int index) {
		super();
		this.data = data;
		this.rem = rem;
		this.index = index;
